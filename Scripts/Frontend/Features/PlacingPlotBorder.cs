...
public partial class PlacingPlotBorder : Node
{
	...
	private static void CreateFencePost(Vector3 _FencePostPosition, Node3D _Storage) {
		PackedScene FencePostScene = GD.Load<PackedScene>("res://Packages/Objects/Fence_Post.tscn");
		Node3D FencePostPrefab = FencePostScene.Instantiate<Node3D>();

		FencePostPrefab.Position = new Vector3(_FencePostPosition.X,PlacingGridHandler.CELL_HEIGHT,_FencePostPosition.Z);
	...
	private static void CreateFenceBridge(Vector3 _PostPosition01, Vector3 _PostPosition02, Node3D _Storage) {
		PackedScene FenceBridgeScene = GD.Load<PackedScene>("res://Packages/Objects/Fence_Middle.tscn");
		...
		FenceBridgePrefab.Position = new Vector3(BridgeCenter.X,PlacingGridHandler.CELL_HEIGHT,BridgeCenter.Z);
	...
	private static void GenerateFencing(Vector3 _Start, Vector3 _End, Node3D _Storage) {
		...
		float FenceItterations = (float)Math.Round(Magnitude / (PlacingGridHandler.CELL_SIZE * 2),0);
	...
	private static void ReCalebrateVoxelFencing(Node3D _Voxel) {
		...
		void CreateFenceSection(List<string> __KeyDirections) {
			...
			Dictionary<String,Vector3> TopKeyToBoundaryConverter = new Dictionary<string, Vector3> {
				["Left"] = _Voxel.Position + new Vector3(PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2,0,PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2),
				["Right"] = _Voxel.Position + new Vector3(PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2,0,PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2 *- 1),
				["Front"] = _Voxel.Position + new Vector3(PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2,0,PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2),
				["Back"] = _Voxel.Position + new Vector3(PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2 *- 1,0,PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2),
			};
			Dictionary<String,Vector3> BottomKeyToBoundaryConverter = new Dictionary<string, Vector3> {
				["Left"] = _Voxel.Position + new Vector3(PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2 *- 1,0,PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2),
				["Right"] = _Voxel.Position + new Vector3(PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2 *- 1,0,PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2 *- 1),
				["Front"] = _Voxel.Position + new Vector3(PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2,0,PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2 *- 1),
				["Back"] = _Voxel.Position + new Vector3(PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2 *- 1,0,PlacingGridHandler.CELL_SIZE * PlacingGridHandler.VOXEL_CLUSTER_SIZE / 2 *- 1),
			};
	...
	// Gets Called in the PlacingVoxelGridHandler
