...
public class MouseRect {
    ...
    private void Set(Viewport _ViewPortInstance) {
        ...
        _ViewPortInstance.SizeChanged += () => CompoundConnections(); // fires when viewport size changed
    ...
    // Constructor
    public MouseRect(Variant _UiObject, Viewport _ViewPortInstance) {
        // Creates Everything
    ...
    // Sets stuff directly
    public void Set(bool _DesiredState) {
        State = _DesiredState;
    }
